...
export default function Header() {
    return (
        <div className={"w-full bg-header h-56"}>
            <div className={"invisible md:visible pl-2 pt-2 fixed opacity-40"}>
                <Image src={"/images/stroke_small.png"} width={379} height={120} alt={"Small paint stroke"}/>
            </div>
            <div className={"invisible md:visible flex w-full h-56 fixed items-end justify-end place-items-end overflow-hidden"}>
